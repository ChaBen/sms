      ...
      <div class="container">
        ...
        <div class="md-layout">
          ...
          >
            <pricing-card card-plain>
              <template slot="cardContent">
                <h6 class="card-category text-gray">Freelancer</h6>
                <div class="icon">
          ...
          >
            <pricing-card>
              <template slot="cardContent">
                ...
                <md-button href="javascript:void(0)" class="md-rose md-round">
                  Choose Plan
                </md-button>
              </template>
            </pricing-card>
          ...
          >
            <pricing-card card-plain>
              <template slot="cardContent">
                <h6 class="card-category text-gray">Medium Company</h6>
                <div class="icon">
          ...
          >
            <pricing-card card-plain>
              <template slot="cardContent">
                <h6 class="card-category text-gray">Enterprise</h6>
                <div class="icon">
    ...
    <div class="section section-pricing-2">
      <div class="container">
        ...
        <div class="md-layout">
          ...
          <div class="md-layout-item md-size-33 md-small-size-100">
            <full-bg-card card-pricing :card-image="cardPricing2.cardPricing1">
              <template slot="cardContent">
          ...
          <div class="md-layout-item md-size-33 md-small-size-100">
            <pricing-card card-plain>
              <template slot="cardContent">
                <h6 class="card-category text-gray">Platinium</h6>
                <h1 class="card-title">
                  <small>$</small>199
                  <small>/mo</small>
                </h1>
      ...
      <div class="container">
        ...
        <div class="md-layout">
          <div class="md-layout-item md-size-25 md-small-size-100">
            <pricing-card card-plain>
              <template slot="cardContent">
                <h6 class="card-category text-gray">Startup</h6>
                <h1 class="card-title"><small>$</small>0</h1>
                <ul>
                  <li>
                    <md-icon class="text-success">check</md-icon> Sharing Tools
                  </li>
                  <li>
                    <md-icon class="text-danger">close</md-icon> Design Tools
                  </li>
                  <li>
                    <md-icon class="text-danger">close</md-icon> Private
                    Messages
                  </li>
                  <li>
                    <md-icon class="text-danger">close</md-icon> Personal Brand
                  </li>
                </ul>
            ...
            <pricing-card card-bg="success">
              <template slot="cardContent">
                ...
                <ul>
                  ...
                  <li>
                    <md-icon class="text-success">check</md-icon> Design Tools
                  </li>
                  <li>
                    <md-icon class="text-danger">close</md-icon> Private
                    Messages
          ...
          <div class="md-layout-item md-size-25 md-small-size-100">
            <pricing-card card-plain>
              <template slot="cardContent">
                <h6 class="card-category text-gray">Large Company</h6>
                ...
                <ul>
                  ...
                  <li>
                    <md-icon class="text-success">check</md-icon> Private
                    Messages
                  </li>
                  <li>
                    <md-icon class="text-danger">close</md-icon> Personal Brand
            ...
            <pricing-card card-plain>
              <template slot="cardContent">
                ...
                <ul>
                  ...
                  <li>
                    <md-icon class="text-success">check</md-icon> Personal Brand
                  </li>
                </ul>
                <md-button
                  href="javascript:void(0)"
