          ...
          <div class="md-layout-item md-large-size-33 md-small-size-100">
            ...
            >
              <template slot="cardContent">
                ...
                <md-button class="md-info md-round">Follow</md-button>
              </template>
            </profile-card>
          </div>
        </div>
          ...
          >
            <pricing-card>
              <template slot="cardContent">
                ...
                <md-button href="javascript:void(0)" class="md-info md-round">
                  Choose Plan
                </md-button>
              </template>
            </pricing-card>
              ...
              <template slot="backRotateCardContent">
                ...
                <div class="stats">
                  <md-button
                    ...
                    class="md-white md-round"
                  >
                    <md-icon class="md-icon-button">subject</md-icon> Read
                  </md-button>
                  <md-button
                    href="javascript:void(0)"
                    class="md-white md-simple md-round"
                  >
                    <md-icon class="md-icon-button">bookmark</md-icon> Bookmark
                  </md-button>
                </div>
              </template>
            </rotating-card>
            ...
            >
              <template slot="frontRotateCardContent">
                ...
                <div class="stats text-center">
                  ...
                  >
                    <md-icon class="md-icon-button">refresh</md-icon> Rotate...
                  </md-button>
                </div>
              </template>
              <template slot="backRotateCardContent">
                ...
                <div class="stats text-center">
                  ...
                  >
                    <md-icon class="md-icon-button">refresh</md-icon> Back...
                  </md-button>
                </div>
              </template>
            </rotating-card>
