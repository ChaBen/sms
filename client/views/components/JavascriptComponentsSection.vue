        ...
        <div class="md-layout-item md-small-size-100">
          ...
          <div class="md-layout">
            ...
            <div class="md-layout-item md-size-33 md-xsmall-size-100">
              ...
              ><md-icon>info_outline</md-icon> Notice Modal</md-button>
            ...
            <div class="md-layout-item md-size-33 md-xsmall-size-100">
              ...
              ><md-icon>notifications</md-icon> Small Alert</md-button>
            ...
            <div class="md-layout-item md-size-50 md-xsmall-size-100">
              ...
              ><md-icon>account_circle</md-icon> Login</md-button>
            ...
            <div class="md-layout-item md-size-50 md-xsmall-size-100">
              ...
              ><md-icon>assignment</md-icon> Signup</md-button>
