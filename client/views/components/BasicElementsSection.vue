      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-xsmall-size-100">
          <div class="vertical-center">
            <md-button class="md-success md-sm">Small</md-button>
            <md-button class="md-success">Regular</md-button>
            <md-button class="md-success md-lg">Large</md-button>
          </div>
        </div>
      </div>
      <div class="title">
    ...
    <div id="sliders">
      <div class="md-layout">
        ...
        <div class="md-layout-item md-size-50 md-xsmall-size-100">
          ...
          <badge type="default" class="badge-pill">Default</badge>
          <badge type="primary" class="badge-pill">Primary</badge>
          <badge type="info" class="badge-pill">Info</badge>
          <badge type="success" class="badge-pill">Success</badge>
          <badge type="warning" class="badge-pill">Warning</badge>
          <badge type="danger" class="badge-pill">Danger</badge>
          <badge type="rose" class="badge-pill">Rose</badge>
        </div>
      </div>
    </div>
    <!-- end sliders -->
