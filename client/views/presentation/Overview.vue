<template>
  <div class="section section-overview">
    <div class="section section-features-5 section-image" :style="features5">
      <div class="md-layout">
        <div
      ...
      <div class="container">
        <div class="md-layout">
          <div class="md-layout-item md-size-25 md-small-size-100">
            <info-areas text-center icon="format_bold">
          ...
          <div class="md-layout-item md-size-25 md-small-size-100">
            <info-areas text-center icon="phonelink">
              <h4 slot="title" class="info-title">Fully Responsive</h4>
              <div slot="content" class="description">
                <p>
    ...
    <div class="section-testimonials team-3">
      <div class="container">
        ...
        <div class="our-clients">
          <div class="md-layout">
            <div class="md-layout-item md-size-25 md-small-size-100">
              <img :src="clients.client1" alt="">
            </div>
            <div class="md-layout-item md-size-25 md-small-size-100">
              <img :src="clients.client2" alt="">
            </div>
            <div class="md-layout-item md-size-25 md-small-size-100">
              <img :src="clients.client3" alt="">
            </div>
            <div class="md-layout-item md-size-25 md-small-size-100">
              <img :src="clients.client4" alt="">
            </div>
          </div>
        </div>
      </div>
