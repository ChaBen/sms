              ...
              <md-card class="md-card-pricing md-card-plain">
                <md-card-content>
                  ...
                  <ul>
                    ...
                    <li>
                      <md-icon class="text-danger">close</md-icon> Sections
                    </li>
                    <li>
                      <md-icon class="text-danger">close</md-icon> Photoshop for
                      Prototype
                    </li>
                    <li>
                      <md-icon class="text-danger">close</md-icon> Premium
                      Support
                    </li>
                  </ul>
                </md-card-content>
              ...
              <md-card class="md-card-pricing md-card-plain">
                <md-card-content>
                  ...
                  <ul>
                    ...
                    <li>
                      <md-icon class="text-success">check</md-icon> Sections
                    </li>
                    <li>
                      <md-icon class="text-success">check</md-icon> Photoshop
                      for Prototype
                    </li>
                    <li>
                      <md-icon class="text-success">check</md-icon> Premium
                      Support
                    </li>
                  </ul>
                </md-card-content>
