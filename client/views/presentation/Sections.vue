      ...
      <div class="md-layout">
        ...
        >
          <div class="section-description">
            ...
            <md-button class="md-rose md-round">View All Sections</md-button>
          </div>
        </div>
      </div>
    </div>
    <div class="container-fluid">
      <div v-for="item in sections" :key="item.key" class="md-layout">
        <div class="md-layout-item md-size-25 md-small-size-100">
          <img :src="item.rowSection1" alt="">
        </div>
        <div class="md-layout-item md-size-25 md-small-size-100">
          <img :src="item.rowSection2" alt="">
        </div>
        <div class="md-layout-item md-size-25 md-small-size-100">
          <img :src="item.rowSection3" alt="">
        </div>
        <div class="md-layout-item md-size-25 md-small-size-100">
          <img :src="item.rowSection4" alt="">
        </div>
      </div>
    </div>
  </div>
